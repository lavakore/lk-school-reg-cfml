          ...
          <tr>
            ...
            <td><p><cfoutput>#R_Part_B_Question#</cfoutput>
              ...
              <p><span id="sprycheckbox1">
                <label>
                  <input type="checkbox" name="Race" value="1" id="Race_0" />
                ...
                <label>
                  <input type="checkbox" name="Race" value="2" id="Race_1" />
                ...
                <label>
                  <input type="checkbox" name="Race" value="3" id="Race_2" />
                ...
                <label>
                  <input type="checkbox" name="Race" value="4" id="Race_3" />
                ...
                <label>
                  <input type="checkbox" name="Race" value="5" id="Race_4" />
