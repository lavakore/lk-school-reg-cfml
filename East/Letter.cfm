...
<cfquery name="UDMe" datasource="RegData">
	UPDATE Registration SET Prog_Login = <cfqueryparam cfsqltype="cf_sql_timestamp" value="#Now()#" >, Prog_Letter = <cfqueryparam cfsqltype="cf_sql_timestamp" value="#Now()#">, RegLang = <cfqueryparam value="#SESSION.Language#" cfsqltype="cf_sql_varchar"> WHERE Student_Number = <cfqueryparam value="#SESSION.Student_Number#" cfsqltype="cf_sql_integer">
</cfquery>
...
<form id="form1" name="form1" method="post" action="./ProcessLetter.cfm">
  <div id="wrap">
    <div id="top"></div>
    <div id="content">
      <div class="header">
      ...
      <div class="middle">
        <h2><cfoutput>#Letter_Dear_Parent_Guardian#</cfoutput></h2>
        <cfif SESSION.Language eq "English"><cfinclude template="Lang/Eng_Welcome.cfm"><cfelse><cfinclude template="Lang/Esp_Welcome.cfm"></cfif>
     ...
     <div class="right">
        ...
        <div> <span class="complete"><cfoutput>#Login#</cfoutput></span><br />
          <span class="current"><cfoutput>#Welcome_Letter#</cfoutput></span><br />
