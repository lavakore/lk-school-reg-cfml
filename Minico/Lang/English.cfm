...
<cfset Letter_Text = "Our School is dedicated to providing all students with the educational foundation necessary to succeed in school and in life. To ensure your child's success, we have set high standards that are reflected in what is taught in our classrooms. As required by federal and state laws and rules, our school's progress toward reading and math goals for all students is evaluated each year. Schools not consistently meeting goals are identified for improvement.

Our school has been identified as needing improvement for: (LEP, reading, math).

Under federal and state laws and rules, students in schools identified for improvement are eligible to apply for transfer to another school within the district that has met state academic goals. However, our district has no transfer options available at this time because only one high school exists at this time.

Our staff continues to work to improve the educational process and to provide quality-learning experiences for your child. (Peer tutoring, Math labs, 0 policy, Teacher tutoring, Language Reading, and Science labs.)

Parent Involvement is essential to our improvement efforts. We invite you to participate in the following ways (Student tutoring, grade checks, school involvement, booster club, activities). To get involved, please contact Minico High School at 436-4721. For questions regarding attendance, contact Mrs. Garro, the attendance secretary at 436-4707.
...
<cfset Sch_Counselors = "Counselors">
<cfset Sch_Last_Name = "Last Name">
<cfset Sch_Counselor = "Counselor">
<cfset Sch_Email_Address = "Email Address">

<!--- Finish Page --->
<cfset Fin_Congrats = "Congratulations!">
<cfset Fin_Now_Reg = "is now registered at Minico High School.">
<cfset Fin_Note = "Please Note: <br />
        <br />
        <ul style='padding-left:20px;'>
          <li>The First day of School for  9th Grade is Friday, August 19.</li>
          <li>The First day of School for Grades 10-12 is Monday, August 22.</li>
