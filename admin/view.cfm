...
function doreset(who, stuname) {
	...
	if (answer) {window.location = "./reset.cfm?return=view.cfm&student_number=" + who;}
}
//-->
</script>
</head>
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="0">
          <tr>
            <th scope="col"><cfif #Sort# eq "OrigName">
                <span class="style1"><a class="style1" href="/admin/view.cfm?Sort=OrigName1">Original Name  </a>
                <cfelseif #Sort# eq "OrigName1">
                <a class="style1" href="/admin/view.cfm?Sort=OrigName">Original Name </a>
                <cfelse>
                <a class="style1" href="/admin/view.cfm?Sort=OrigName">Original Name </a> </span>
              </cfif></th>
            <th scope="col"><cfif #Sort# eq "Name">
                <span class="style1"><a class="style1" href="/admin/view.cfm?Sort=Name1">Name  </a>
                <cfelseif #Sort# eq "Name1">
                <a class="style1" href="/admin/view.cfm?Sort=Name">Name </a>
                <cfelse>
                <a class="style1" href="/admin/view.cfm?Sort=Name">Name </a> </span>
              </cfif></th>
            <th scope="col"><cfif #Sort# eq "Grade">
                <span class="style1"><a class="style1" href="/admin/view.cfm?Sort=Grade1">Grade  </a>
                <cfelseif #Sort# eq "Grade1">
                <a class="style1" href="/admin/view.cfm?Sort=Grade">Grade </a>
                <cfelse>
                <a class="style1" href="/admin/view.cfm?Sort=Grade">Grade </a> </span>
              </cfif></th>
            <th scope="col"><cfif #Sort# eq "DT">
                <span class="style1"><a class="style1" href="/admin/view.cfm?Sort=DT1">Date/Time  </a>
                <cfelseif #Sort# eq "DT1">
                <a class="style1" href="/admin/view.cfm?Sort=DT">Date/Time </a>
                <cfelse>
                <a class="style1" href="/admin/view.cfm?Sort=DT">Date/Time </a> </span>
              </cfif></th>
          ...
          <cfoutput query="RegStu" startrow="#StartRow_RegStu#" maxrows="#MaxRows_RegStu#">
            <tr>
              <td scope="col"<cfif #trim(RegStu.OrigLN)# neq #trim(RegStu.Last_Name)# or #trim(RegStu.OrigFN)# neq #trim(RegStu.First_Name)#> bgcolor="##FFFF00"<cfelseif #trim(RegStu.OrigMN)# neq #trim(RegStu.Middle_Name)#> bgcolor="##FFFFCC"</cfif>><div align="left" style="text-transform:capitalize">#RegStu.OrigLN#, #RegStu.OrigFN# #RegStu.OrigMN#</div></td>
              <td scope="col"<cfif #trim(RegStu.OrigLN)# neq #trim(RegStu.Last_Name)# or #trim(RegStu.OrigFN)# neq #trim(RegStu.First_Name)#> bgcolor="##FFFF00"<cfelseif #trim(RegStu.OrigMN)# neq #trim(RegStu.Middle_Name)#> bgcolor="##FFFFCC"</cfif>><div align="left" style="text-transform:capitalize"><a href="/admin/details.cfm?Student_Number=#RegStu.Student_Number#">#RegStu.Last_Name#, #RegStu.First_Name# #RegStu.Middle_Name#</a></div></td>
              <td scope="col"><div align="center">#RegStu.Grade_Level#</div></td>
              <td scope="col"><div align="center">#LSDateFormat(dateadd("h",-6,RegStu.Prog_Login),'MMM D')#, #lcase(LSTimeFormat(dateadd("h",-6,RegStu.Prog_Login),'h:mmtt'))#</div></td>
              <td scope="col"><div align="center">#RegStu.RegLang#</div></td>

              <td scope="col"><div align="left">#RegStu.Guardian#</div></td>
              <td scope="col" style="text-align:right;"><a href="javascript:;" style="text-decoration:none; border:none;" onclick="doreset(#regstu.student_number#,'#regstu.Last_Name#, #regstu.First_Name#');"><img src="/admin/images/table_refresh.gif" width="16" height="16" alt="Reset" style="border:none;" /></a></td>
              
            </tr>
          </cfoutput>
           <cfif regstu.recordcount eq 0>
          <tr>
            <td colspan="7">
            No Records Found.
            </td>
