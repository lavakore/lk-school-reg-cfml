    ...
    <div id="all">
      ...
      <div class="content">
        ...
        <form action="<cfoutput>#CurrentPage#</cfoutput>" method="post" name="form1" id="form1">
          <input name="Return" type="button" id="Return" onclick="MM_goToURL('self','/admin/view.cfm');return document.MM_returnValue" value="Return to List" />
...
<div id="end_body"></div>
<div id="footer"> &copy; 2008-2010 Minidoka County Joint School District #331  <br />
